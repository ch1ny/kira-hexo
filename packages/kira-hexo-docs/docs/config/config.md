...
```yaml
avatar: https://kira.host/assets/Pictures/Others/20220922230447.jpg # 网站 Logo
background: # 既是博客的背景，又是文章默认头图
    path: https://kira.host/assets/Pictures/Others/-f0d5cc34c6e5aa7_compressed.jpg
    width: 1280
    height: 720
favicon:
...
# beian: 赣ICP备2021007955号-3 # 备案号（选填，别往你们网站上挂我的备案号！！！）
...
social:
    QQ:
        - tencent://AddContact/?fromId=45&fromSubId=1&subcmd=all&uin=<去掉尖括号后填上你的QQ号>&website=www.oicqzone.com
        - icon-QQ
        - rgb(49, 174, 255)
        - rgba(49, 174, 255, .1)
    哔哩哔哩:
        - https://space.bilibili.com/<改成你的B站uid>
        - icon-bilibili
        - rgb(231, 106, 141)
        - rgba(231, 106, 141, .15)
    GitHub:
        - https://github.com/<你的github id>/
        - icon-github
        - rgb(25, 23, 23)
        - rgba(25, 23, 23, .15)
    Gitee:
        - https://gitee.com/<你的gitee id>
        - icon-gitee
        - rgb(165, 15, 15)
        - rgba(165, 15, 15, .15)
...
giscus:
    ...
    repo: -your github username-/-your giscus repo- # 存放评论的 discus 所在的 repo
    repoID: -your giscus repo ID- # GitHub repo ID
    category: Announcements # 选择新 discussions 所在的分类
    categoryID: -giscus category id- # 分类 ID
